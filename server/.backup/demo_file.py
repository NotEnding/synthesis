...
if __name__ == '__main__':
    ...
    # 合成文本
    parser.add_argument('-f', '--file', default='text', dest='file', help='file to be synthesized')
    ...
    try:
        ...
        ws.connect()
        with open(args.file, encoding='utf-8') as fid:
            text = ''.join(fid.readlines())

        event = dict(spkid=args.speaker, text=text)
        ...
        wf.write('ftest.wav', rate=options['sample_rate'], data=norm_data)
