...
from tacotron_v2.feeder import Feeder
from tacotron_v2.models import create_model
from tacotron_v2.utils import ValueWindow, plot
from tacotron_v2.utils.text import sequence_to_text
from tacotron_v2.utils.symbols import symbols
...
def add_train_stats(model, hparams):
	with tf.variable_scope('stats') as scope:
		...
		if hparams.predict_linear:
			...
			tf.summary.histogram('mel_outputs', model.linear_outputs)
			tf.summary.histogram('mel_targets', model.linear_targets)
		...
		gradient_norms = [tf.norm(grad) for grad in model.grads]
